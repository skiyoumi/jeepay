 ...
 */
@Service("ezfpPaymentByWxNativeService") //Service Name需保持全局唯一性
public class WxNative extends EzfpPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ rq, PayOrder payOrder, MchAppConfigContext mchAppConfigContext) {
        ...
        JSONObject resObj = doApiPay(payOrder, mchAppConfigContext, EzfpKit.TYPE_WXPAY, channelRetMsg);
        if (resObj == null) {
